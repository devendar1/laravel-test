...
class EventsController extends BaseController
{
    ...
    public function getEventsWithWorkshops() {
        $event_workshops = Event::with('workshops')->get()->toArray();
        return response()->json($event_workshops);
    ...
    public function getFutureEventsWithWorkshops() {
        $events_not_started = Event::with('workshops')->where('id','!=',1)->get()->toArray();
        return response()->json($events_not_started);
